...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.sim_cutoff = 0.7
        self.grid_size = 0.1
        self.t_grid_size = 2.0

        self.grad_pruning_iter = 1000
        self.grad_pruning_opt_iter = 1000
        self.merge_opt_iter = 1000
        self.net_opt_iter = 5000
        ...
        self.slice_scale = 0.0
        self.cluster_scale = 0.0
        self.slice_rot = 0.0
        self.cluster_rot = 0.0
        self.slice_app = 0.0
        self.cluster_app = 0.0
        
        self.slice_scale_t = 0.0
        self.cluster_scale_t = 0.0
        self.slice_rot_r = 0.0
        self.cluster_rot_r = 0.0
